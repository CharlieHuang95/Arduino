int checkForBall(){
  if(currentGameboard < 42){
    ballHasBeenPutIn = 1;
    if(currentGameboard > 36) column = 7;
    else if(currentGameboard > 32) column = 6;
    else if(currentGameboard > 28) column = 5;
    else if(currentGameboard > 24) column = 4;
    else if(currentGameboard > 20) column = 3;
    else if(currentGameboard > 15) column = 2;
    else if(currentGameboard > 10) column = 1;
    
  }
}

//Call when a ball is put in
int gameState( int column){	
    while(1){
	...
	bestColumn = calculateBestMove(connectBoard);
      }
      return bestColumn;
}
